			...
			<div class="row" style="flex-wrap: nowrap;">
				<div class="col-md-6 home-left-section">
					<div style="padding: 100px 0px; color: white;">
						...
						<hr>
						<p>
							Tusgun restaurant gives you abeautfull and delicious meals<br><br> to full fill your desires.<br><br> You are warmely welcome  
						</p>
				...
				<div class="col-md-6 home-right-section" style="display:flex;align-items:center;justify-content:center;padding:40px 20px;">
	                    <img src="Design/images/pizza_image.png" alt="Delicious Dish" style="width:100%;max-width:420px;border-radius:12px;box-shadow:0 8px 24px rgba(0,0,0,0.4);">
	                </div>
			</div>
		</div>
	</section>
            ...
            <div class="row">
                <div class="col-lg-6 sm-padding">
                    <div class="contact-info">
						...
						<p>
							tusgun is a different kind of restaurant. Founded by TUSGUN in 2003, we’re an employee-owned firm pursuing a democratic design process that values everyone’s input.
						</p>
                        <h3>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="footer_widget">
						<img src="Design/images/restaurant-logo.svg" alt="TUSGUN RESTAURANT" style="width: 150px;margin-bottom: 20px;">
                        <p>
                ...
                <div class="col-lg-3 col-md-6">
                     <div class="footer_widget">
						<h3>Headquarters</h3>
						<p>
							<?php echo isset($restaurant_headquarters) ? $restaurant_headquarters : $restaurant_address; ?>
						</p>
                        <p>
                            <?php echo $restaurant_email; ?>
                            <br>
