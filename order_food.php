...
?>
	...
	<section class="order_food_section">
        ...
        <?php
            ...
            {
                // Selected Menus
                $selected_menus = isset($_POST['selected_menus']) ? $_POST['selected_menus'] : array();

                if (empty($selected_menus)) {
                    echo "<div class='alert alert-danger'>Please select at least one item!</div>";
                    // don't continue processing the order
                    return;
                }
